...
context('User Management', () => {
	...
	describe('Enterprise User - User Management Permissions', () => {
		...
		it('Test 7 - Validate CustomerChangeCloser section permissions checkboxes are disabled', function () {
		...
		it('Test 8 - Validate CustomerChangeCloser section permissions checkboxes are enabled', function () {
